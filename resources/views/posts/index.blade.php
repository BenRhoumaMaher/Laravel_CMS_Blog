        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="blog-entry">
                    ...
                    <span class="date">{{ $post->created_at }}</span>
                    <h2><a href="{{ route('posts.single',$post->id) }}">{{ substr($post->title,0,25) }} ...</a></h2>
                ...
                <div class="post-entry-alt">
                    ...
                    <div class="excerpt">
                        ...
                        <div class="post-meta align-items-center text-left clearfix">
                            {{-- <figure class="author-figure mb-0 me-3 float-start"><img src="{{  }}" alt="Image" class="img-fluid"></figure> --}}
