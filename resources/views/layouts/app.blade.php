...
<body>
    <div id="app">
                ...
                <div class="menu-bg-wrap">
                    <div class="site-navigation">
                        <div class="row g-0 align-items-center">
                            <div class="col-2">
                                <a href="{{ url('/posts/index') }}" class="logo m-0 float-start">M&Code<span class="text-primary">.</span></a>
                            </div>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('single.profile',auth()->user()->id) }}">
                                       Profile
                                    </a>
        ...
        @if (session()->has('delete'))
            <p class="container alert alert-success mt-3">{{ session('delete') }}</p>
        @endif

        @if (session()->has('profile'))
            <p class="container alert alert-success mt-3 text-center">{{ session('profile') }}</p>
        @endif
