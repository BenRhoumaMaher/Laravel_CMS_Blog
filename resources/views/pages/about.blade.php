...
<div class="site-cover site-cover-sm same-height overlay single-page" style="background-image: url('images/hero_5.jpg'); margin-top: -25px">
    <div class="container">
...
<div class="section sec-halfs py-0">
    <div class="container">
        ...
        <div class="half-content d-lg-flex align-items-stretch">
            <div class="img order-md-2" style="background-image: url('{{ asset('assets/images/hero_3.jpg') }}')" data-aos="fade-in">
    ...
    <div class="container">
        <div class="row justify-content-between">
            <div class="col-lg-7 mb-4 mb-lg-0">
                <img src="{{ asset('assets/images/hero_5.jpg') }}" alt="Image" class="img-fluid rounded
                ">
            </div>
